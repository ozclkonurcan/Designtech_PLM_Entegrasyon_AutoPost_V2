...
namespace Designtech_PLM_Entegrasyon_AutoPost_V2
{
    ...
    CREATE TABLE " + scheman + @".Change_Notice_LogTable (
      ...
      ProcessTimestamp datetime
        ...
        private void btnStartAutoPost_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                AutoPost(cancellationTokenSource.Token, anlikTarih);
        ...
        private void çalýþtýrToolStripMenuItem_Click(object sender, EventArgs e)
        {
