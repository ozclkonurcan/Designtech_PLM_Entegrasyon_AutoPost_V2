...
([LogID] ASC));";
	...
	"             @TimestampDefinitionID BIGINT," +
	"             @UpdateCount INT," +
	" 			 @StringValuePartID BIGINT," +
	" 			 @StringValueEntegrasyonDurumID BIGINT;" +
	...
	"         -- Veriyi ekle" +
	"         INSERT INTO " + scheman + ".Des_LogDataReviseAndSaveAsProcess (statestate, PartID, AnaNumber, AnaParcaAd, Number, ParcaAd, Version, KulAd, LogCode, LogMesaj)" +
	"         VALUES (@State, @Part_ID, NULL, NULL, @Number, @ParcaAd, @Versiyon, @KulAd, 'DES-WTP-005', 'Parça oluşturuldu ve işlemde');" +
	...
	"             -- Debug: Değerleri ekleyin" +
	"             INSERT INTO " + scheman + ".DebugTable (Part_ID, StringDefinitionID, UpdateCount, DebugMessage)" +
	"             VALUES (@Part_ID, @StringDefinitionID, @UpdateCount, 'Güncelleme başarılı');" +
	"         END" +
	"         ELSE" +
	"         BEGIN" +
	"             -- Debug: Değerleri ekleyin" +
	"             INSERT INTO " + scheman + ".DebugTable (Part_ID, StringDefinitionID, UpdateCount, DebugMessage)" +
	"             VALUES (@Part_ID, @StringDefinitionID, 0, 'Kayıt bulunamadı');" +
	"         END" +
	"     END" +
	" END";
	...
	"     SELECT @Part_ID = idA2A2, @State = statestate, @Versiyon = versionIdA2versionInfo + '.' + iterationIdA2iterationInfo, @KulID = idA3D2iterationInfo, @MasterID = idA3masterReference, @ViewID = idA3view FROM INSERTED;" +

	"     SELECT @ParcaAd = name, @Number = WTPartNumber FROM " + scheman + ".WTPartMaster WHERE idA2A2 = @MasterID;" +

	"     SELECT @KulAd = name FROM " + scheman + ".WTUser WHERE idA2A2 = @KulID;" +

	"     SELECT @ViewAd = name FROM " + scheman + ".WTView WHERE idA2A2 = @ViewID;" +
	...
	"     -- Equivalence Güncellemeleri" +
	"     IF @idA3B6 = @ViewID" +
	"     BEGIN" +
	"         UPDATE " + scheman + ".Des_EquivalenceLink_LogTable" +
	"         SET APartState = @State" +
	"         WHERE idA3A5 = @Part_ID AND idA3B5 != @Part_ID; -- Ek Koşul Eklendi" +
	"     END" +
	"     ELSE IF @idA3A6 = @ViewID" +
	"     BEGIN" +
	"         UPDATE " + scheman + ".Des_EquivalenceLink_LogTable" +
	"         SET BPartState = @State" +
	"         WHERE idA3B5 = @Part_ID AND idA3A5 != @Part_ID; -- Ek Koşul Eklendi" +
	"     END" +

	"     -- Muadil Güncellemeleri" +
	"     IF @AnaParcaPartID = @Part_ID" +
	"     BEGIN" +
	"         UPDATE " + scheman + ".Des_AlternateLink_LogTable" +
	"         SET AnaParcaState = @State" +
	"         WHERE AnaParcaPartID = @Part_ID AND MuadilParcaPartID != @Part_ID; -- Ek Koşul Eklendi" +
	"     END" +
	"     ELSE IF @MuadilParcaPartID = @Part_ID" +
	"     BEGIN" +
	"         UPDATE " + scheman + ".Des_AlternateLink_LogTable" +
	"         SET MuadilParcaState = @State" +
	"         WHERE MuadilParcaPartID = @Part_ID AND AnaParcaPartID != @Part_ID; -- Ek Koşul Eklendi" +
	"     END" +
	" END";
			#endregion
	...
	"	[EntegrasyonDurum] [tinyint] NULL," +
	"	[LogMesaj] [nvarchar](300) NULL," +
	" CONSTRAINT [PK_Des_AlternateLink_LogTable] PRIMARY KEY CLUSTERED" +
	"(" +
	"	[LogID] ASC" +
	...
	"	[EntegrasyonDurum] [tinyint] NULL," +
	"	[LogMesaj] [nvarchar](300) NULL," +
	" CONSTRAINT [PK_Des_AlternateLink_LogTable_Takip] PRIMARY KEY CLUSTERED" +
	"(" +
	"	[LogID] ASC" +
	")WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 100, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]" +
	") ON [PRIMARY] TEXTIMAGE_ON [PRIMARY];" +
	...
	"	[EntegrasyonDurum] [tinyint] NULL," +
	"	[LogMesaj] [nvarchar](300) NULL," +
	" CONSTRAINT [PK_Des_AlternateLinkRemoved_LogTable] PRIMARY KEY CLUSTERED" +
	"(" +
	"	[LogID] ASC" +
	")WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 100, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]" +
	") ON [PRIMARY] TEXTIMAGE_ON [PRIMARY];" +
	...
	"	[idA2A2] [bigint] NULL," +
	"	[EntegrasyonDurum] [tinyint] NULL," +
	" CONSTRAINT [PK_Des_EquivalenceLink_LogTable] PRIMARY KEY CLUSTERED" +
	"(" +
	"	[ID] ASC" +
	...
	"	[idA2A2] [bigint] NULL," +
	"	[EntegrasyonDurum] [tinyint] NULL," +
	" CONSTRAINT [PK_Des_EquivalenceLink_LogTable_Takip] PRIMARY KEY CLUSTERED" +
	"(" +
	"	[ID] ASC" +
	")WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 100, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]" +
	") ON [PRIMARY] TEXTIMAGE_ON [PRIMARY];";
	...
	" CONSTRAINT [PK_Des_EPMDocument_LogTable] PRIMARY KEY CLUSTERED" +
	"(" +
	"	[Ent_ID] ASC" +
	")WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 100, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]" +
	") ON [PRIMARY];";
	...
	"	[name] [nvarchar](200) NULL," +
	"	[docNumber] [nvarchar](200) NULL," +
	" CONSTRAINT [PK_Des_EPMDocument_LogTable_Cancelled] PRIMARY KEY CLUSTERED" +
	"(" +
	"	[Ent_ID] ASC" +
	")WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 100, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]" +
	") ON [PRIMARY];";
	...
	"	[name] [nvarchar](200) NULL," +
	"	[docNumber] [nvarchar](200) NULL," +
	" CONSTRAINT [PK_Des_EPMDocument_LogTable_Cancelled_Error] PRIMARY KEY CLUSTERED" +
	"(" +
	"	[Ent_ID] ASC" +
	")WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 100, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]" +
	") ON [PRIMARY];";
	...
	"	[name] [nvarchar](200) NULL," +
	"	[docNumber] [nvarchar](200) NULL," +
	" CONSTRAINT [PK_Des_EPMDocument_LogTable_Cancelled_Takip] PRIMARY KEY CLUSTERED" +
	"(" +
	"	[Ent_ID] ASC" +
	")WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 100, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]" +
	") ON [PRIMARY];";
	...
	"	[name] [nvarchar](200) NULL," +
	"	[docNumber] [nvarchar](200) NULL," +
	" CONSTRAINT [PK_Des_EPMDocument_LogTable_Error] PRIMARY KEY CLUSTERED" +
	"(" +
	"	[Ent_ID] ASC" +
	")WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 100, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]" +
	") ON [PRIMARY];";
	...
	"	[name] [nvarchar](200) NULL," +
	"	[docNumber] [nvarchar](200) NULL," +
	" CONSTRAINT [PK_Des_EPMDocument_LogTable_Takip] PRIMARY KEY CLUSTERED" +
	"(" +
	"	[Ent_ID] ASC" +
	")WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 100, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]" +
	") ON [PRIMARY];";
