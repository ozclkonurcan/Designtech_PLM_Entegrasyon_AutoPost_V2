namespace Designtech_PLM_Entegrasyon_AutoPost_V2
{
    partial class Form1
    {
		...
		private void InitializeComponent()
		{
			...
			// btnStartAutoPost
			// 
			btnStartAutoPost.Location = new Point(1234, 208);
			...
			label5.Location = new Point(698, 292);
			label5.Name = "label5";
			...
			// 
			button1btnStopAutoPost.Location = new Point(1107, 208);
			...
			// btnKapat
			// 
			btnKapat.Location = new Point(979, 208);
			...
			lblDataCount.Location = new Point(828, 294);
			...
			groupBox5.Location = new Point(1351, 28);
			groupBox5.Name = "groupBox5";
			groupBox5.Size = new Size(279, 785);
			...
			listBox2.Size = new Size(267, 684);
			listBox2.TabIndex = 0;
			// 
			// contextMenuStrip1
			// 
			...
			Text = "Designtech PLM Entegrasyon";
			Resize += Form1_Resize;
